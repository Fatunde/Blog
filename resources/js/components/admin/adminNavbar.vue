        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <div class="row ml-lg-3">
                    ...
                    <div class="row" v-if="Pending_users"> <i class="fas fa-bell text-danger" style="margin-top: 10px; margin-left: 6px; font-size: 15px;">
                        </i>
                        <div class="text-danger m-1">{{Pending_users}}</div>
                    </div>
                </div>
